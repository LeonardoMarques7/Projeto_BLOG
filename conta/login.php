    ...
    <div class="container">
        <main id="posts-container">
            <div class="form-center">
                ...
                <form name="produto" action="functions.php" method="post" enctype="multipart/form-data" class="form-login"><br>
                    <?php if (isset($_SESSION['message'])) {
                        echo '<div class="message-error-login">' . $_SESSION['message'] . '</div>';
                        clear_message();
                    } ?>
                    <figure class="mb-2">
                        <img src="<?= BASEURL ?>img/288-logo-etec-fernando-prestes.svg" alt="" class="logo-fp">
                        <figcaption><small style="opacity: 50%;" class="text-small">Projeto de TCC: <b>Blog do Fernando Prestes</b></small></figcaption>
                    </figure>
                    <div class="col">
                    ...
                    <b class="title-cria">Não tem uma conta? </b><a href="index.php" class="link-login">Clique aqui</a>
                    <div class="br"></div>
                    <br>
