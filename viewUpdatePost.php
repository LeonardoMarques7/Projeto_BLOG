    ...
    <div class="container">
        <main id="posts-container">
            ...
            <form name="produto"  style="padding: 50px; padding-top: 0px;" action="alterarPost.php" class="form border rounded shadow-lg" method="post" enctype="multipart/form-data"><br><br>
                ...
                <div class="col text-start">
                    <b>Assuno Introdutório do Post:</b><br><textarea name="assuntoIntro" id="assunto" class="form-control" value='<?php echo $dados['assuntoIntro'];?>'><?php echo $dados['assuntoIntro'];?></textarea><br>
                    <button class="btn-small-textarea" title="Texto em Strong" type="button" onclick="adicionarAtalho('<strong></strong>')"><i class="fa-solid fa-bold"></i></button>
                    <button class="btn-small-textarea" title="Texto em Itálico" type="button" onclick="adicionarAtalho('<em></em>')"><i class="fa-solid fa-italic"></i></button>
                    <button class="btn-small-textarea" title="Link" type="button" onclick="adicionarAtalho('<a href=&quot;URL&quot;>TITULO-LINK</a>')"><i class="fa-solid fa-link"></i></button>
                    <script>
                ...
                <div class="col text-start">
                    ...
                    <button class="btn-small-textarea" title="Texto em Strong" type="button" onclick="adicionarAtalho2('<strong></strong>')"><i class="fa-solid fa-bold"></i></button>
                    <button class="btn-small-textarea" title="Texto em Itálico" type="button" onclick="adicionarAtalho2('<em></em>')"><i class="fa-solid fa-italic"></i></button>
                    <button class="btn-small-textarea" title="Link" type="button" onclick="adicionarAtalho2('<a href=&quot;URL&quot;>TITULO-LINK</a>')"><i class="fa-solid fa-link"></i></button>
                    <script>
